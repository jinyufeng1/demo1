package com.example.demo1.module;
...
public class CodeGenerator {
    ...
    private static InjectionConfig getInjectionConfig(String projectPath, String moduleName) {
        ...
        focList.add(new FileOutConfig("templates/mapper.xml.ftl") { // "customTemplates/mapper.xml.ftl" .ftl 后缀根据模版引擎调整
            @Override
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/" + module; // 获得当前模块项目的路径
        ...
        mpg.execute();// 执行的时候会将前面的配置信息加入到同一个map中，对应模版文件中的占位符，最终输出目标文件
    }
